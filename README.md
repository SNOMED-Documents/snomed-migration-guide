# Migrating to SNOMED CT: A Practical Guide
...
The guide does not cover EHR procurement requirements (covered in the separate EHR Requirements for Procurement Support document) or SNOMED CT authoring and content management (covered in SNOMED International's editorial guidance).

**Implementation Maturity Framework.** SNOMED International's Implementation Maturity Framework is a structured self-assessment tool tailored to NRCs, user organisations, and vendors separately. It can be used at any point in a migration to identify current position, prioritise effort, and track progress. The framework and self-assessment tool are available separately and can be used alongside this guide.
