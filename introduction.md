...
This guide covers the full arc of a SNOMED CT migration and is structured as follows:
...
* [Terminology Strategy](2-terminology-strategy.md) explains the reference-to-primary spectrum and the decision of how directly clinicians will engage with SNOMED CT.
* [System and Data Migration](3-system-and-data-migration.md) distinguishes changes to the underlying data from changes to the systems clinicians use, and why conflating the two creates avoidable failure.
* [The Architectural Context](<4 the-architectural-context/README.md>) describes the standards and infrastructure — FHIR, terminology services, and more — that a migration plan must account for.
